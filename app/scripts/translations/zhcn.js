...
/* Navigation*/
NAV_AddWallet               : '添加萌娘工坊 ',
NAV_BulkGenerate            : '批量创建 ',
NAV_Contact                 : '联系工坊创世神 ',
NAV_Contracts               : '魔法契约',
NAV_DeployContract          : '部署魔法契约',
NAV_ENS                     : '魔法印记',
NAV_GenerateWallet_alt      : '新的萌娘工坊 ',
NAV_GenerateWallet          : '创建新的萌娘工坊 ',
NAV_Help                    : '帮助 ',
NAV_InteractContract        : '使用契约魔法 ',
NAV_Multisig                : 'Multisig ',
NAV_MyWallets               : '我的萌娘工坊 ',
NAV_Offline                 : '离线传送 ',
NAV_SendEther               : '传送【工坊价值】 /道具转移 ', //combined these tabs
NAV_DomainSale              : '魔法印记转移',
NAV_SendTokens              : '传送工坊道具 ',
NAV_SignMsg                 : '签名契约 ',
NAV_Swap                    : '交换 ',
NAV_ViewWallet              : '查看工坊/工作台信息 ',
NAV_YourWallets             : '你的萌娘工坊 ',
...
x_PrivKey                   : '工坊密语（未加密） ',
x_PrivKey2                  : '【工坊密语】 ',
x_PrivKeyDesc               : '这是未加密的文本格式【工坊密语】文件，这意味传送【道具】或者签订【魔法契约】不需要密码。 如果某个人拿到了你的未加密的【工坊密语】，他们无需密码就能够控制你的【工坊】或者【工作台】。 出于这个考虑，我们推荐你使用加密的【工坊密语】文件。 ',
x_Save                      : '保存 ',
x_TXT                       : 'TXT文件存放工坊密语（未加密） ',
x_Wallet                    : '钱包 ',
...
/* Sidebar */
sidebar_AccountInfo         : '工作台信息： ',
sidebar_AccountAddr         : '工作台的魔法名： ',
sidebar_AccountBal          : '工作台存放魔法水晶： ',
sidebar_TokenBal            : '道具一览： ',
sidebar_Equiv               : '价值： ',
sidebar_TransHistory        : '交互历史： ',
sidebar_donation            : '萌娘工坊网络是一个去中心化的魔法网络~',
sidebar_donate              : '哇哦 ',
sidebar_thanks              : '感谢你！！！ ',
...
/* Decrypt Panel */
decrypt_Access              : '您讲通过哪种形式打开萌娘工坊~ ',
decrypt_Title               : '选择你的【工坊密语】文件格式： ',
decrypt_Select              : '选择一个工作台： ',

/* Add Wallet */
ADD_Label_1                 : '你想执行什么操作？ ',
ADD_Radio_1                 : '生成新【工坊】 ',
ADD_Radio_2                 : '选择你的【工坊密语】文件（Keystore/JSON） ',
ADD_Radio_2_alt             : '选择你的【工坊密语】文件： ',
ADD_Radio_2_short           : '选择【工坊密语】文件... ',
ADD_Radio_3                 : '粘贴/输入你的【工坊密语】 ',
ADD_Radio_4                 : '观察一个工作台 ',
...
ADD_Label_2                 : '创建一个工坊昵称： ',
ADD_Label_3                 : '你的钱包被加密，请输入密码： ',
ADD_Label_4                 : '添加一个查看账户 ',
ADD_Warning_1               : '你在可以工坊页面添加任何要查看的工坊，不需要使用【工坊密语】，但是这样你无权操作工坊，仅查看。 ',
ADD_Label_5                 : '输入地址： ',
ADD_Label_6                 : '解除结界，进入工坊 ',
ADD_Label_6_short           : '解除',
ADD_Label_7                 : '增加工作台 ',
...
GEN_Label_3                 : '保存你的【魔法名】。 ',
GEN_Label_4                 : '打印你的【工坊密语】，或者将其存储二维码。（可选） ',
...
SEND_addr                   : '传送至其他工坊【填写其他工作台魔法名】： ',
SEND_amount                 : '传送数量： ',
SEND_amount_short           : '数量 ',
SEND_custom                 : '自定义 ',
SEND_gas                    : '【魔法消耗】 ',
SEND_TransferTotal          : '发送所有剩余 ',
SEND_generate               : '生成传送咒语 ',
SEND_raw                    : '未生效咒语 ',
SEND_signed                 : '附魔咒语 ',
SEND_trans                  : '激活咒语（将生效） ',
SEND_custom                 : '根据魔法名添加新的道具',
SENDModal_Title             : '警告！ ',
/* full sentence reads "You are about to send "10 ETH" to address "0x1234". Are you sure you want to do this? " */
SENDModal_Content_1         : '你将传送 ',
SENDModal_Content_2         : '到魔法名下 ',
SENDModal_Content_3         : '你确定这样做吗？ ',
SENDModal_Content_4         : '注意：如果你遇到错误，你最有可能向你的账户添加【魔法水晶】，用以支付发送【道具】所需的【少量魔法能量】。 【少量魔法能量】将消耗【魔法水晶】。 ',
SENDModal_No                : '不，离开这里。 ',
SENDModal_Yes               : '是的，我确定！激活传送咒语（将生效）。 ',
...
TRANS_data                  : '数据： ',
TRANS_gas                   : '【魔法能量消耗】： ',
TRANS_sendInfo              : '一笔标准传送咒式需要21000【微小魔法能量体】，损耗0.000441【魔法结晶】。我们将1个【微小魔法能量体】的能量设为0.000000021【魔法结晶】，略高于最低【魔法能量单体】，以保证咒式被快速被【魔法维度】承认并且激活。',
...
OFFLINE_Step2_Label_3       : '魔法能量损耗值 ',
OFFLINE_Step2_Label_3b      : '在你的连网电脑的第1步骤中显示了。 ',
OFFLINE_Step2_Label_4       : '【魔法能量】限制 ',
OFFLINE_Step2_Label_4b      : '21000是默认的【魔法能量】限制。当你发送【魔法契约】或者【契约升级】时，【魔法能量】限制可能会不同。没使用的【魔法能量】将返回给你。 ',
OFFLINE_Step2_Label_5       : 'Nonce ',
OFFLINE_Step2_Label_5b      : '在你的连网电脑的第1步中显示了。 ',
OFFLINE_Step2_Label_6       : '数据 ',
OFFLINE_Step2_Label_6b      : '这是可选项。当你向合约发送交易时，往往需要用到数据。 ',
OFFLINE_Step2_Label_7       : '输入/选择你的【工坊密语】文件/JSON ',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : '你可以通过这种方式转换不同的【工坊密语】的存储方式。',
VIEWWALLET_Subtitle_Short   : '你可以通过这种方式转换不同的【工坊密语】的存储方式。',
VIEWWALLET_SuccessMsg       : '正在载入你的萌娘工坊~ ',
VIEWWALLET_ShowPrivKey      : '(显示)',
VIEWWALLET_HidePrivKey      : '(隐藏)',

/* Chrome Extension */
CX_error_1                  : '你没有工坊中的工作台。点击["添加工作台"]，添加一个工作台。 ',
CX_quicksend                : '快速传送 ', // if no appropriate translation, just use "Send"
...
/* Contracts */
CONTRACT_Title              : '魔法契约的魔法名 ',
CONTRACT_Title_2            : '已被录入的【魔法契约】',
CONTRACT_Json               : 'ABI / JSON 魔法接口 ',
CONTRACT_Interact_Title     : '读取魔法凭据 / 使用契约魔法 ',
CONTRACT_Interact_CTA       : '选择一个契约上的魔法 ',
CONTRACT_ByteCode           : '魔法契约的字节码 ',
CONTRACT_Read               : '读取 ',
CONTRACT_Write              : '执行 ',
...
ERROR_32                    : '无法连接至魔力节点，请刷新你的页面, 或者尝试连接其他工坊的备用节点或者自建的私有魔力节点~', // 32
...
HELP_7_Title                : '7) 我怎样才能传送道具给他人的工作台，或者怎样添加一个已存在与魔法空间的魔法道具？',
