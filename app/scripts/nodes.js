...
nodes.nodeList = {
    'moeh': {
        ...
        'type': nodes.nodeTypes.MOEH,
        'eip155': true,
        'chainId': 12,
        'tokenList': require('./tokens/moehTokens.json'),
        'abiList': require('./abiDefinitions/moehAbi.json'),
        'service': '魔力工坊位面',
        'lib': new nodes.customNode('http://47.52.235.110', '8545')
    }
};
