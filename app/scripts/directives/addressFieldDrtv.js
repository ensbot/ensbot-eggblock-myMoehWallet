...
var addressFieldDrtv = function($compile) {
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            var placeholder = attrs.placeholder == undefined ? '请输入一个存在于【魔法位面】的【魔法契约】的魔法名' : attrs.placeholder ;
            var labelTranslated = attrs.labeltranslated == undefined ? '发送物的【魔法名】' : attrs.labeltranslated;
